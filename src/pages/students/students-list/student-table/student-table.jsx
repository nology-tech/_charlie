...
const StudentTable = (props) => {
    ...
    const students = pageData && pageData.map(student => <React.Fragment key={student.studentName}><StudentTableRow student={student} toggleView = {toggleView}/></React.Fragment>)
    return ( 
        <>

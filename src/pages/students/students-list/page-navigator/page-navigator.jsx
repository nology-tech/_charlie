    ...
    return (
        <div className="page-nav row d-flex align-items-center p-0 w-100 ms-0">
            <div className="page-nav__rows-selector col-2 offset-8 d-flex align-items-center text-center p-0">
                ...
                <select name="rows" defaultValue="8" className="page-nav__rows-selector__button" onChange= {changeNumberOfRows} data-testid="rows-selector">
            ...
            <div className="page-nav__rows-of-total col-1 p-0 text-end">
                <p className="page-nav__rows-of-total__text m-0 p-0" data-testid="row-selection">{`${firstIndex+1}-${secondIndex} of ${totalNumberStudents}`}</p>
            </div>

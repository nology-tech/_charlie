        ...
        <div className="col-6">
          <div className="col-12 mt-4">
            ...
            <img
              ...
              src={src}
              alt={alt}
              className="student-thumbnail my-2"
            />
          ...
          <div className="col-12 mt-3">
            ...
            <div>
              <label htmlFor="cvUpload" className="btn upload-btn mt-2">
                Upload
              </label>
              <input
                {...register("cvUpload")}
          ...
          <div className="col-12 mt-5">
            <input
              type="reset"
              className="btn btn-secondary mx-2 form__button"
              value="Cancel"
              onClick={handleClick}
            />
            <input
